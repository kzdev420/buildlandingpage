...
var editor = grapesjs.init({
    ...
    pluginsOpts: {
        ...
        gjspresetwebpage: {
            ...
            modalImportLabel: '<div style="margin-bottom: 10px; font-size: 13px;">Paste here your HTML/CSS an' +
                    'd click Import</div>',
...
pn
    .getButton('options', 'sw-visibility')
    .set('active', 1);
